        ...
        <div className="max-w-[1690px] mx-auto h-full flex items-center justify-between lg:justify-start px-3">
          <div>
            <div className="border-r relative lg:w-[280px]">
              ...
              <div
                className={`lg:w-full w-[230px] transition-all duration-300 lg:absolute fixed top-1/2 -translate-y-1/2 lg:-translate-y-0 z-20 lg:left-0  ${
                  isOpen
                    ? "lg:top-12 opacity-100 left-0"
                    : "lg:top-14 lg:opacity-0 left-[-230px]"
                }`}
              >
